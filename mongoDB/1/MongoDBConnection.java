...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "lbarros360_db_user";
    private static final String PASSWORD = "1ioH7ZIZ6vqm90FH";
    private static final String CLUSTER_URL = "cluster0.a1iufay.mongodb.net"; // Substitua pelo seu cluster se for diferente
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            operations.readUsuario();

            //Altere a idade de Bob para 32 anos.
            operations.updateUsuarioIdade("Bob", 32);
